...
module.exports = {
  ...
  AirFriend: {
    ...
    bbox: new ms.BBox({ x1: 45, y1: 30, x2: 45 + 110, y2: 30 + 120 })
  },
  AirNeutral: {
  ...
  AirUnknown: {
    ...
    bbox: new ms.BBox({ x1: 25, y1: 20, x2: 25 + 150, y2: 20 + 130 })
  },
  GroundHostile: {
  ...
  GroundFriend: {
    ...
    bbox: new ms.BBox({ x1: 25, y1: 50, x2: 25 + 150, y2: 50 + 100 })
  },
  GroundNeutral: {
  ...
  SeaFriend: {
    ...
    bbox: new ms.BBox({ x1: 40, y1: 40, x2: 40 + 120, y2: 40 + 120 })
  },
  SeaNeutral: {
    g: { type: "path", d: "M45,45 l110,0 0,110 -110,0 z" },
    bbox: new ms.BBox({ x1: 45, y1: 45, x2: 45 + 110, y2: 45 + 110 })
  ...
  SubsurfaceHostile: {
    ...
    bbox: new ms.BBox({ x1: 45, y1: 50, x2: 45 + 110, y2: 50 + 130 })
  },
  SubsurfaceFriend: {
    g: { type: "path", d: "m 45,50 c 0,100 40,120 55,120 15,0 55,-20 55,-120" },
    bbox: new ms.BBox({ x1: 45, y1: 50, x2: 45 + 110, y2: 50 + 120 })
  },
  SubsurfaceNeutral: {
  ...
  SubsurfaceUnknown: {
    ...
    bbox: new ms.BBox({ x1: 25, y1: 50, x2: 25 + 150, y2: 50 + 130 })
  },
  PositionMarker: {
    g: { type: "circle", cx: 100, cy: 100, r: 15 },
    bbox: new ms.BBox({ x1: 85, y1: 85, x2: 115, y2: 115 })
  }
};
