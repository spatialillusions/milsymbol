...
module.exports = function (iconParts, properties, colors, STD2525, monoColor, alternateMedal){
	...
	*/
	...
	iconParts['TP.DESTROY'] = !STD2525 && !numberSIDC ? {type:'path',fill:false,strokedasharray:'12,5',d:'M 0,155 200,45 M 0,45 200,155'} : [{type:'path',fill:false,d:'m 0,45 85,46.75 m 30,16.5 85,46.75 M 0,155 85,108.25 M 115,91.75 200,45'},{type:'text',stroke:false,textanchor:"middle",x:100,y:115,fontsize:45,text:'D'}];
	iconParts['TP.INTERDICT'] = !STD2525 && !numberSIDC ? {type:'path',fill:false,d:'m 0,100 200,0 M 0,155 200,45.2 M 185,85 l 15,15 -15,15 m 9.2,-49.3 5.5,-20.5 -20.5,-5.5'} : [{type:'path',fill:false,d:'m 194.203,65.6674 5.49,-20.4904 -20.49,-5.4904 M 115,91.75 200,45 M 0,155 85,108.25 M 185,85 l 15,15 -15,15 m -70,-15 85,0 m -200,0 85,0'},{type:'text',stroke:false,textanchor:"middle",x:100,y:115,fontsize:45,text:'I'}];
	iconParts['TP.NEUTRALIZE'] = !STD2525 && !numberSIDC ? [{type:'path',fill:false,d:'M 0,45 200,155'},{type:'path',fill:false,strokedasharray:'12,5',d:'M 0,155 200,45'}] : [{type:'path',fill:false,d:'M 115,108.25 200,155 M 0,45 85,91.75'},{type:'path',fill:false,strokedasharray:'12,5',d:'M 115,91.75 200,45 M 0,155 85,108.25'},{type:'text',stroke:false,textanchor:"middle",x:100,y:115,fontsize:45,text:'N'}];
	iconParts['TP.DATUM'] = [{type:'path',stroke:false,d:'m 100,50 0,50 50,0 C 150,72.3858 127.614,50 100,50 Z m 0,50 -50,0 c 0,27.614 22.3858,50 50,50 z'},{type:'circle',fill:false,cx:100,cy:100,r:50}];
	...
	iconParts['TP.NAVIGATIONAL REFERENCE'] = (!numberSIDC && STD2525 ? {type:'path',fill:false,d:'M 160,160 40,160 40,40 160,40 Z M 160,160 40,40 M 40,160 160,40'} : {type:'path',fill:false,d:'M 160,160 40,40 M 40,160 160,40'});
	...
	iconParts['TP.POINT OF INTEREST'] = [{type:'path',d:'M 129.021,41.957 C 121.48,49.9458 110.986,54.4816 100,54.5 89.0432,54.4928 78.569,49.9914 71.0234,42.0469 L 100,100 Z'},{type:'circle',fill:false,cx:100,cy:15,r:40}];
	...
	iconParts['TP.DROP POINT'] = {type:'path',fill:false,d:'m 130,100 0,-40 m -60,40 0,-40 m 60,40 0,0 c 0,8.284 -6.716,15 -15,15 -8.284,0 -15,-6.716 -15,-15 m 0,0 0,0 c 0,8.284 -6.7157,15 -15,15 -8.2843,0 -15,-6.716 -15,-15 m 30,-40 0,40'};
	...
	iconParts['TP.TANKING'] = [iconParts['TP.AIR CONTROL'],{type:'text',stroke:false,textanchor:"middle",x:100,y:(!numberSIDC&&!STD2525 ? 155 : 115),fontsize:45,text:'K'},(!numberSIDC&&!STD2525 ? {type:'circle',cx:100,cy:100,r:15} : [])];
	iconParts['TP.FIXED WING'] = [iconParts['TP.AIR CONTROL'],(!numberSIDC && !STD2525 ? [{type:'text',stroke:false,textanchor:"middle",x:100,y:155,fontsize:45,text:'F'},{type:'circle',cx:100,cy:100,r:15}] : [{type:'text',stroke:false,textanchor:"middle",x:100,y:75,fontsize:32,text:'ASW'},{type:'path',d:'m 100,81.3203 c -1.5135,-0 -2.5365,2.6426 -2.5365,2.6426 l -0.1365,14.1465 -28.3641,29.9996 0.1484,4.604 28.5162,-18.748 -0.2929,24.43 -6.3073,6.017 -0.096,3.766 8.0313,-3.524 1.0312,3.326 0,0.02 0,-0.01 0,0.01 0,-0.02 1.0312,-3.326 8.031,3.524 -0.09,-3.766 -6.309,-6.017 -0.293,-24.43 28.518,18.748 0.146,-4.604 -28.364,-29.9996 -0.136,-14.1465 c 0,0 -1.014,-2.6416 -2.528,-2.6426 z',stroke:false}] )];
	iconParts['TP.ROTARY WING'] = [iconParts['TP.AIR CONTROL'],(!numberSIDC && !STD2525 ? [{type:'text',stroke:false,textanchor:"middle",x:100,y:155,fontsize:45,text:'H'},{type:'circle',cx:100,cy:100,r:15}] : [{type:'text',stroke:false,textanchor:"middle",x:100,y:75,fontsize:32,text:'ASW'},{type:'path',d:'m 65,80 0,40 70,-40 0,40 -70,-40',stroke:false}] )];
	...
	iconParts['TP.STRIKE IP'] = [iconParts['TP.AIR CONTROL'],(!numberSIDC && !STD2525 ? [{type:'text',stroke:false,textanchor:"middle",x:100,y:155,fontsize:45,text:'S'},{type:'circle',cx:100,cy:100,r:15}] : {type:'text',stroke:false,textanchor:"middle",x:100,y:115,fontsize:45,text:'S'} )];
	iconParts['TP.TACAN'] = [iconParts['TP.AIR CONTROL'],{type:'text',stroke:false,textanchor:"middle",x:100,y:(!numberSIDC&&!STD2525 ? 155 : 115),fontsize:45,text:'T'},(!numberSIDC&&!STD2525 ? {type:'circle',cx:100,cy:100,r:15} : [])];
	iconParts['TP.TOMCAT'] = [iconParts['TP.AIR CONTROL'],(!numberSIDC && !STD2525 ? [{type:'text',stroke:false,textanchor:"middle",x:100,y:155,fontsize:45,text:'O'},{type:'circle',cx:100,cy:100,r:15}] : {type:'text',stroke:false,textanchor:"middle",x:100,y:115,fontsize:45,text:'TC'} )];
	iconParts['TP.RESCUE'] = [iconParts['TP.AIR CONTROL'],(!numberSIDC && !STD2525 ? [{type:'text',stroke:false,textanchor:"middle",x:100,y:155,fontsize:45,text:'R'},{type:'circle',cx:100,cy:100,r:15}] : {type:'text',stroke:false,textanchor:"middle",x:100,y:115,fontsize:45,text:'RC'} )];
	iconParts['TP.REPLENISH'] = [iconParts['TP.AIR CONTROL'],(!numberSIDC && !STD2525 ? [{type:'text',stroke:false,textanchor:"middle",x:100,y:155,fontsize:45,text:'F'},{type:'circle',cx:100,cy:100,r:15}] : {type:'text',stroke:false,textanchor:"middle",x:100,y:115,fontsize:45,text:'RP'} )];
	...
	iconParts['TP.FORWARD OBSERVER POSITION'] = [iconParts['TP.OBSERVATION POST/RECONNAISSANCE'],{type:'path',d:'m 115,100 c 0,8.284 -6.716,15 -15,15 -8.2843,0 -15,-6.716 -15,-15 0,-8.2843 6.7157,-15 15,-15 8.284,0 15,6.7157 15,15 z'}];
	...
	iconParts['TP.BOOBY TRAP'] = {type:'path',fill:false,d:'M 77.2413,87.9311 100,50 122.781,87.9687 M 130,100 c 0,10.24 -13.431,18.541 -30,18.541 -16.5685,0 -30,-8.301 -30,-18.541 0,-10.2399 13.4315,-18.541 30,-18.541 16.569,0 30,8.3011 30,18.541 z'};
	iconParts['TP.UNSPECIFIED MINE'] = {type:'path',fill:false,d:'m 129,100 c 0,16.016 -12.984,29 -29,29 -16.0163,0 -29,-12.984 -29,-29 0,-16.0163 12.9837,-29 29,-29 16.016,0 29,12.9837 29,29 z'};
	iconParts['TP.ANTITANK MINE (AT)'] = {type:'path',d:'m 129,100 c 0,16.016 -12.984,29 -29,29 -16.0163,0 -29,-12.984 -29,-29 0,-16.0163 12.9837,-29 29,-29 16.016,0 29,12.9837 29,29 z'};
	...
	iconParts['TP.RELEASE EVENTS CHEMICAL'] = [{type:'path',fill:(!monoColor?'rgb(255,255,0)':false),d:'m 85,-15 0,59.0625 C 75.7313,49.4137 70.0154,59.2975 70,70 c 0,16.5685 13.4315,30 30,30 16.569,0 30,-13.4315 30,-30 -0.01,-10.7067 -5.728,-20.5959 -15,-25.9492 L 115,-15 Z'},{type:'text',stroke:false,textanchor:"middle",x:100,y:80,fontsize:35,text:'C'},{type:'text',stroke:false,textanchor:"end",x:50,y:60,fontsize:35,text:'CML'}];
	...
	iconParts['TP.NUCLEAR TARGET'] = {type:'path',fill:false,d:'m 90,100 -40,0 m 50,10 0,40 m 10,-50 40,0 m -50,-10 0,-40 m 2.5,50 c 0,1.381 -1.119,2.5 -2.5,2.5 -1.3807,0 -2.5,-1.119 -2.5,-2.5 0,-1.3807 1.1193,-2.5 2.5,-2.5 1.381,0 2.5,1.1193 2.5,2.5 z'};
	...
	iconParts['TP.SP CLASS VI'] = [iconParts['TP.SUPPLY POINT'],{type:'path',fill:false,d:'m 75,-20 50,0 m -25,15 15,25 m -15,-50 0,25 -20,25 m 30,-60 c 0,5.5228 -4.477,10 -10,10 -5.5228,0 -10,-4.4772 -10,-10 0,-5.5228 4.4772,-10 10,-10 5.523,0 10,4.4772 10,10 z'}];
	iconParts['TP.SP CLASS VII'] = [iconParts['TP.SUPPLY POINT'],{type:'path',fill:false,d:'m 85,-25 c 10,-10 20,-10 30,0'},{type:'path',d:'m 129.6,-20 c 0,5.3019 -4.298,9.5999 -9.6,9.5998 -5.302,10e-5 -9.6,-4.2979 -9.6,-9.5998 0,-5.3019 4.298,-9.5999 9.6,-9.5998 5.302,-1e-4 9.6,4.2979 9.6,9.5998 z m -40.4886,0 c 0,5.0321 -4.0793,9.1114 -9.1114,9.1114 -5.0321,0 -9.1114,-4.0793 -9.1114,-9.1114 0,-5.0321 4.0793,-9.1114 9.1114,-9.1114 5.0321,0 9.1114,4.0793 9.1114,9.1114 z'}];
	iconParts['TP.SP CLASS VIII'] = [iconParts['TP.SUPPLY POINT'],{type:'path',fill:false,d:'m 60,-15 80,0 m -40,-45 0,90'}];
	iconParts['TP.SP CLASS IX'] = [iconParts['TP.SUPPLY POINT'],{type:'path',fill:false,d:'m 121.213,-36.2132 -7.08,7.0802 M 85.8669,-0.866982 78.7868,6.2132 m 0,-42.4264 7.0801,7.0802 m 28.2661,28.266018 7.08,7.080182 M 100,-45 l 0,10 m 0,40 0,10 m -30,-30 10,0 m 40,0 10,0 m -10,0 c 0,11.04569 -8.954,20 -20,20 -11.0457,0 -20,-8.95431 -20,-20 0,-11.0457 8.9543,-20 20,-20 11.046,0 20,8.9543 20,20 z'}];
	...
	iconParts['TP.WRECK, DANGEROUS'] = [iconParts['TP.WRECK, NON DANGEROUS'],{type:'path',strokedasharray:'5,5',fill:false,d:'m 156.547,100 c 0,16.382 -25.162,29.662 -56.202,29.662 -31.0395,0 -56.2019,-13.28 -56.2017,-29.662 0,-16.3818 25.1624,-29.6618 56.2017,-29.6618 31.039,-1e-4 56.202,13.28 56.202,29.6618 z'},];
	...
	iconParts['TP.FIX ELECTRO-OPTICAL'] = {type:'path',fill:false,d:'m 150,100 c 0,6.904 -22.386,12.5 -50,12.5 -27.6142,0 -50,-5.596 -50,-12.5 0,-6.9036 22.3858,-12.5 50,-12.5 27.614,0 50,5.5964 50,12.5 z M 50,150 150,50 M 50,50 150,150 m -50,-100 0,100'};
}
