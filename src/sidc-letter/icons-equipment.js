...
module.exports = function equipment(sId,bbox,icn,_STD2525){
	...
	sId['S-G-EWMAT-'] = [MS._translate(0,-15,MS.scale(0.7,icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR'])),icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR THEATRE']];
	sId['S-G-EWMATR'] = [MS._translate(0,-15,MS.scale(0.7,icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR'])),icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR THEATRE'],icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR TLAR']];
	sId['S-G-EWMATE'] = [MS._translate(0,-15,MS.scale(0.7,icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR'])),icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR THEATRE'],icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR TELAR']];
	...
	sId['S-G-EWHLS-'] = [MS._translate(0,-15,MS.scale(0.8,[icn['GR.EQ.HOWITZER'],icn['GR.EQ.SHORT RANGE']])),icn['GR.EQ.HOWITZER TRACKED']];
	sId['S-G-EWHM--'] = [icn['GR.EQ.HOWITZER'],icn['GR.EQ.INTERMEDIATE RANGE']];
	sId['S-G-EWHMS-'] = [MS._translate(0,-15,MS.scale(0.8,[icn['GR.EQ.HOWITZER'],icn['GR.EQ.INTERMEDIATE RANGE']])),icn['GR.EQ.HOWITZER TRACKED']];
	sId['S-G-EWHH--'] = [icn['GR.EQ.HOWITZER'],icn['GR.EQ.LONG RANGE']];
	sId['S-G-EWHHS-'] = [MS._translate(0,-15,MS.scale(0.8,[icn['GR.EQ.HOWITZER'],icn['GR.EQ.LONG RANGE']])),icn['GR.EQ.HOWITZER TRACKED']];
	...
	sId['S-G-EWDLS-'] = [MS._translate(0,-15,MS.scale(0.8,[icn['GR.EQ.DIRECT FIRE GUN'],icn['GR.EQ.SHORT RANGE']])),icn['GR.EQ.HOWITZER TRACKED']];
	sId['S-G-EWDM--'] = [icn['GR.EQ.DIRECT FIRE GUN'],icn['GR.EQ.INTERMEDIATE RANGE']];
	sId['S-G-EWDMS-'] = [MS._translate(0,-15,MS.scale(0.8,[icn['GR.EQ.DIRECT FIRE GUN'],icn['GR.EQ.INTERMEDIATE RANGE']])),icn['GR.EQ.HOWITZER TRACKED']];
	sId['S-G-EWDH--'] = [icn['GR.EQ.DIRECT FIRE GUN'],icn['GR.EQ.LONG RANGE']];
	sId['S-G-EWDHS-'] = [MS._translate(0,-15,MS.scale(0.8,[icn['GR.EQ.DIRECT FIRE GUN'],icn['GR.EQ.LONG RANGE']])),icn['GR.EQ.HOWITZER TRACKED']];
