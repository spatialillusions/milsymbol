...
module.exports = function ground(sId,bbox,icn,_STD2525){
	...
	sId['S-G-UCFTR-'] = [MS._translate(-30,10,MS.scale(0.6,icn['GR.IC.FIELD ARTILLERY'])),icn['GR.IC.RADAR']];
	sId['S-G-UCFTS-'] = [MS._translate(0,30,MS.scale(0.7,icn['GR.IC.FIELD ARTILLERY'])),icn['GR.IC.FF.SOUND']];
	...
	sId['S-G-UUMRS-'] = [MS._translate(0,30,MS.scale(0.8,icn['GR.IC.MILITARY INTELLIGENCE'])),icn['GR.IC.FF.SENSOR']];
	sId['S-G-UUMRSS'] = [MS._translate(0,30,MS.scale(0.8,icn['GR.IC.MILITARY INTELLIGENCE'])),icn['GR.IC.FF.SENSOR'],icn['GR.M1.SENSOR CONTROL MODULE']];
	...
	sId['S-G-USS3A-'] = [icn['GR.IC.FF.SUPPLY'],icn['GR.IC.FF.CLASS III'],MS._translate(25,5,MS.scale(0.5,icn['GR.IC.AVIATION ROTARY WING']))];
	sId['S-G-USS3AT'] = [icn['GR.IC.FF.SUPPLY THEATER'],icn['GR.IC.FF.CLASS III'],MS._translate(25,5,MS.scale(0.5,icn['GR.IC.AVIATION ROTARY WING']))];
	sId['S-G-USS3AC'] = [icn['GR.IC.FF.SUPPLY CORPS'],icn['GR.IC.FF.CLASS III'],MS._translate(25,5,MS.scale(0.5,icn['GR.IC.AVIATION ROTARY WING']))];
