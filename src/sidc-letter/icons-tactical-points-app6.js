...
//sidc['G-C-MG PF E-****'] = [];//2.X.2.1.1.1.1.1
//sidc['G-C-MG PF A-****'] = [];//2.X.2.1.1.1.1.2
//sidc['G-C-MG PF O-****'] = [];//2.X.2.1.1.1.1.3
//sidc['G-C-MG PI --****'] = [];//2.X.2.1.1.1.2
//sidc['G-C-MA AP --****'] = [];//2.X.2.1.2.1.1
//sidc['G-C-MA AC --****'] = [];//2.X.2.1.2.1.2
//sidc['G-C-MA AU --****'] = [];//2.X.2.1.2.1.3
//sidc['G-C-MA AD --****'] = [];//2.X.2.1.2.1.4
//sidc['G-C-MM PT --****'] = [];//2.X.2.1.4.1.1
//sidc['G-C-MM PO --****'] = [];//2.X.2.1.4.1.4
//sidc['G-C-MM PO C-****'] = [];//2.X.2.1.4.1.4.1
//sidc['G-C-MM PO R-****'] = [];//2.X.2.1.4.1.4.2
//sidc['G-C-MM PO F-****'] = [];//2.X.2.1.4.1.4.3
//sidc['G-C-MM PO S-****'] = [];//2.X.2.1.4.1.4.4
//sidc['G-C-MM PO N-****'] = [];//2.X.2.1.4.1.4.5
//sidc['G-C-MM PO N-****'] = [];//2.X.2.1.4.1.4.6
//sidc['G-C-MM PO N-****'] = [];//2.X.2.1.4.1.4.7
...
//sidc['G-C-OX RN --****'] = [];//2.X.2.5.1.1.1
//sidc['G-C-OX RD --****'] = [];//2.X.2.5.1.1.2
//sidc['G-C-OX UD --****'] = [];//2.X.2.5.1.2.1
//sidc['G-C-OX UB --****'] = [];//2.X.2.5.1.2.2
//sidc['G-C-OX UL --****'] = [];//2.X.2.5.1.2.3
//sidc['G-C-OX US --****'] = [];//2.X.2.5.1.2.4
//sidc['G-C-OX WA --****'] = [];//2.X.2.5.1.3.1
//sidc['G-C-OX WD --****'] = [];//2.X.2.5.1.3.2
//sidc['G-C-OX WE --****'] = [];//2.X.2.5.1.3.3
//sidc['G-C-OX WG --****'] = [];//2.X.2.5.1.3.4
//sidc['G-C-OX WM --****'] = [];//2.X.2.5.1.3.5
//sidc['G-C-OX WI --****'] = [];//2.X.2.5.1.3.6
//sidc['G-C-OX WP --****'] = [];//2.X.2.5.1.3.7
//sidc['G-C-OX Y- --****'] = [];//2.X.2.5.1.4
//sidc['G-C-OX YP --****'] = [];//2.X.2.5.1.4.1
//sidc['G-C-OX YD --****'] = [];//2.X.2.5.1.4.2
//sidc['G-C-OX YL --****'] = [];//2.X.2.5.1.4.3
//sidc['G-C-OX YC --****'] = [];//2.X.2.5.1.4.4
//sidc['G-C-OX YS --****'] = [];//2.X.2.5.1.4.5
//sidc['G-C-OX YB --****'] = [];//2.X.2.5.1.4.6
//sidc['G-C-OX YA --****'] = [];//2.X.2.5.1.4.7
//sidc['G-C-OX YV --****'] = [];//2.X.2.5.1.4.8
//sidc['G-C-OX YT --****'] = [];//2.X.2.5.1.4.9
//sidc['G-C-OX YR --****'] = [];//2.X.2.5.1.4.10
//sidc['G-C-OX YK --****'] = [];//2.X.2.5.1.4.11
//sidc['G-C-OX N- --****'] = [];//2.X.2.5.1.5
//sidc['G-C-OX H- --****'] = [];//2.X.2.5.1.6
//sidc['G-C-OX HQ --****'] = [];//2.X.2.5.1.6.1
//sidc['G-C-OX HA --****'] = [];//2.X.2.5.1.6.2
//sidc['G-C-OX HY --****'] = [];//2.X.2.5.1.6.3
//sidc['G-C-OX HX --****'] = [];//2.X.2.5.1.6.4
//sidc['G-C-OX R- --****'] = [];//2.X.2.5.1.7
//sidc['G-C-OX RR --****'] = [];//2.X.2.5.1.7.1
//sidc['G-C-OX RD --****'] = [];//2.X.2.5.1.7.2
//sidc['G-C-OX RW --****'] = [];//2.X.2.5.1.7.3
//sidc['G-C-OX RP --****'] = [];//2.X.2.5.1.7.4
//sidc['G-C-OX RT --****'] = [];//2.X.2.5.1.7.5
//sidc['G-C-OX ST C-****'] = [];//2.X.2.5.1.8.1
//sidc['G-C-OX ST CP****'] = [];//2.X.2.5.1.8.1.1
//sidc['G-C-OX ST CA****'] = [];//2.X.2.5.1.8.1.2
//sidc['G-C-OX ST R-****'] = [];//2.X.2.5.1.8.2
//sidc['G-C-OX ST H****'] = [];//2.X.2.5.1.8.3
//sidc['G-C-OX ST S-****'] = [];//2.X.2.5.1.8.4
//sidc['G-C-OX ST SA****'] = [];//2.X.2.5.1.8.5
//sidc['G-C-OX S- --****'] = [];//2.X.2.5.1.9
//sidc['G-C-OX SA --****'] = [];//2.X.2.5.1.9.1
//sidc['G-C-OX SD --****'] = [];//2.X.2.5.1.9.2
//sidc['G-C-OX SC --****'] = [];//2.X.2.5.1.9.3
//sidc['G-C-OX AC --****'] = [];//2.X.2.5.1.10.1
//sidc['G-C-OX AA --****'] = [];//2.X.2.5.1.10.2
//sidc['G-C-OX AT --****'] = [];//2.X.2.5.1.10.3
//sidc['G-C-OX AK --****'] = [];//2.X.2.5.1.10.4
//sidc['G-C-OX AF --****'] = [];//2.X.2.5.1.10.5
//sidc['G-C-OX AH --****'] = [];//2.X.2.5.1.10.6
//sidc['G-C-OX AO --****'] = [];//2.X.2.5.1.10.7
//sidc['G-C-OX AR --****'] = [];//2.X.2.5.1.10.8
//sidc['G-C-OX AP --****'] = [];//2.X.2.5.1.10.9
//sidc['G-C-OX AM --****'] = [];//2.X.2.5.1.10.10
//sidc['G-C-OX AS --****'] = [];//2.X.2.5.1.10.11
//sidc['G-C-OX AD --****'] = [];//2.X.2.5.1.10.12
//sidc['G-C-OG -- --****'] = [];//2.X.2.5.2
//sidc['G-C-OG C- --****'] = [];//2.X.2.5.2.1
//sidc['G-C-OG P- --****'] = [];//2.X.2.5.2.2
//sidc['G-C-OG T- --****'] = [];//2.X.2.5.2.3
//sidc['G-C-OG D- --****'] = [];//2.X.2.5.2.4
//sidc['G-C-OG L- --****'] = [];//2.X.2.5.2.5
//sidc['G-C-OG N- --****'] = [];//2.X.2.5.2.6
//sidc['G-C-OG R- --****'] = [];//2.X.2.5.2.7
//sidc['G-C-OG S- --****'] = [];//2.X.2.5.2.8
//sidc['G-C-OG I- --****'] = [];//2.X.2.5.2.9
//sidc['G-C-OG W- --****'] = [];//2.X.2.5.2.10
//sidc['G-O-VA -- --****'] = [];//2.X.3.1.1
//sidc['G-O-VR -- --****'] = [];//2.X.3.1.2
//sidc['G-O-VE -- --****'] = [];//2.X.3.1.3
sidc['G-O-VB----'] = icn['AIR.MISSILE.IC.BOMB'];//2.X.3.1.4
//sidc['G-O-VY -- --****'] = [];//2.X.3.1.5
//sidc['G-O-VD -- --****'] = [];//2.X.3.1.6
...
//sidc['G-O-LB -- --****'] = [];//2.X.3.2.1
//sidc['G-O-LG -- --****'] = [];//2.X.3.2.2
//sidc['G-O-LW -- --****'] = [];//2.X.3.2.3
//sidc['G-O-PR -- --****'] = [];//2.X.3.3.1
//sidc['G-O-PR B- --****'] = [];//2.X.3.3.1.1
//sidc['G-O-PT -- --****'] = [];//2.X.3.3.2
//sidc['G-O-PC -- --****'] = [];//2.X.3.3.3
//sidc['G-O-PC U- --****'] = [];//2.X.3.3.3.1
//sidc['G-O-PD -- --****'] = [];//2.X.3.3.4
//sidc['G-O-PM -- --****'] = [];//2.X.3.3.5
//sidc['G-O-PH -- --****'] = [];//2.X.3.3.6
//sidc['G-O-PH Y- --****'] = [];//2.X.3.3.6.1
//sidc['G-O-PH W- --****'] = [];//2.X.3.3.6.2
//sidc['G-O-PH G- --****'] = [];//2.X.3.3.6.3
//sidc['G-O-PH T- --****'] = [];//2.X.3.3.6.4
//sidc['G-O-PG -- --****'] = [];//2.X.3.3.7
//sidc['G-O-PS -- --****'] = [];//2.X.3.3.8
//sidc['G-O-PF -- --****'] = [];//2.X.3.3.9
//sidc['G-O-PI -- --****'] = [];//2.X.3.3.10
//sidc['G-O-PE -- --****'] = [];//2.X.3.3.11
//sidc['G-O-PX -- --****'] = [];//2.X.3.3.12
//sidc['G-O-PJ V- --****'] = [];//2.X.3.3.13.1
//sidc['G-O-PJ A- --****'] = [];//2.X.3.3.13.2
//sidc['G-O-PJ B- --****'] = [];//2.X.3.3.13.3
//sidc['G-O-PK -- --****'] = [];//2.X.3.3.14
//sidc['G-O-PA -- --****'] = [];//2.X.3.3.15
//sidc['G-O-PO -- --****'] = [];//2.X.3.3.16
//sidc['G-O-IR -- --****'] = [];//2.X.3.4.1
//sidc['G-O-IS -- --****'] = [];//2.X.3.4.2
//sidc['G-O-IG -- --****'] = [];//2.X.3.4.3
//sidc['G-O-IV -- --****'] = [];//2.X.3.4.4
//sidc['G-O-IK -- --****'] = [];//2.X.3.4.5
//sidc['G-O-ID -- --****'] = [];//2.X.3.4.6
