...
module.exports = function activites(sId,sIdm1,sIdm2,bbox,symbolSet,icn,_STD2525){
	...
	if(symbolSet == "40" ){
		...
		sId['110123'] = [ms._translate(0,10,ms._scale(0.8,icn['AC.IC.CRIMINAL.ACTIVITY.INCIDENT'])),icn['AC.M1.THREAT']];
		...
		sId['110302'] = [ms._translate(0,15,ms._scale(0.7,[icn['ST.IC.EXPLOSION'],icn['ST.IC.IED']])),icn['ST.M1.PREMATURE']];
		...
		sId['110604'] = [icn['ST.IC.EXPLOSION'],ms._scale(0.6,icn['GR.EQ.MORTAR'])];
		sId['110605'] = [icn['ST.IC.EXPLOSION'],ms._scale(0.6,icn['GR.EQ.SINGLE ROCKET LAUNCHER'])];
		...
		sId['131201'] = [ms._scale(0.7,icn['GR.IC.FF.EMERGENCY OPERATION']),icn['AC.M1.EMERGENCY COLLECTION EVACUATION POINT']];
		sId['131202'] = [icn['ST.IC.FOOD DISTRIBUTION']];
		sId['131203'] = [ms._scale(0.7,icn['GR.IC.FF.EMERGENCY OPERATION']),icn['AC.M1.EMERGENCY INCIDENT COMMAND CENTER']];
		sId['131204'] = [ms._scale(0.7,icn['GR.IC.FF.EMERGENCY OPERATION']),icn['AC.M1.EMERGENCY OPERATIONS CENTER']];
		sId['131205'] = [icn['AC.IC.EMERGENCY PUBLIC INFORMATION CENTER']];
		sId['131206'] = [ms._scale(0.7,icn['GR.IC.FF.EMERGENCY OPERATION']),icn['AC.M1.EMERGENCY SHELTER']];
		sId['131207'] = [ms._scale(0.7,icn['GR.IC.FF.EMERGENCY OPERATION']),icn['AC.M1.EMERGENCY STAGING AREA']];
		...
		sId['160500'] = [icn['ST.IC.EXPLOSION'],ms._scale(0.7,icn['ST.IC.KNOWN INSURGENT VEHICLE'])];
