...
//Land Equipment
	if(symbolSet == "15" ){
		...
		sId['110301'] = [icn['GR.EQ.GRENADE LAUNCHER'],ms._translate(0,20,icn['GR.EQ.SHORT RANGE'])];
		sId['110302'] = [icn['GR.EQ.GRENADE LAUNCHER'],ms._translate(0,20,icn['GR.EQ.INTERMEDIATE RANGE'])];
		sId['110303'] = [icn['GR.EQ.GRENADE LAUNCHER'],ms._translate(0,20,icn['GR.EQ.LONG RANGE'])];
		...
		sId['111601'] = [icn['GR.EQ.MULTIPLE ROCKET LAUNCHER'],ms._translate(0,10,icn['GR.EQ.SHORT RANGE'])];
		sId['111602'] = [icn['GR.EQ.MULTIPLE ROCKET LAUNCHER'],ms._translate(0,10,icn['GR.EQ.INTERMEDIATE RANGE'])];
		sId['111603'] = [icn['GR.EQ.MULTIPLE ROCKET LAUNCHER'],ms._translate(0,10,icn['GR.EQ.LONG RANGE'])];
		...
		sId['130000'] = [icn['GR.EQ.ARMOURED PROTECTED VEHICLE WITH LIMITED CROSS COUNTRY MOBILITY'],ms._scale(0.7,icn['GR.IC.ENGINEER'])];
		sId['130100'] = [icn['GR.IN.IC.BRIDGE']];
		sId['130200'] = [icn['GR.EQ.UTILITY VEHICLE'],ms._scale(0.8,icn['GR.IN.IC.BRIDGE'])];
		...
		sId['130701'] = [ms._scale(0.7,icn['GR.IC.DRILLING']),icn['GR.EQ.UTILITY VEHICLE']];
		...
		sId['130901'] = [icn['GR.EQ.MINE CLEARING EQUIPMENT'],ms._translate(0,-10,icn['GR.EQ.LIMITED CROSS-COUNTRY'])];
		sId['130902'] = [icn['GR.EQ.MINE CLEARING EQUIPMENT'],icn['GR.EQ.TANK']];
		sId['131000'] = [icn['GR.IC.MINE LAYING']];
		sId['131001'] = [icn['GR.EQ.UTILITY VEHICLE'],ms._translate(0,10,ms._scale(0.7, icn['GR.IC.MINE LAYING']))];
		...
		sId['131200'] = [icn['GR.EQ.ARMOURED PERSONNEL CARRIER'],ms._scale(0.6,icn['GR.IC.ENGINEER'])];
		sId['131300'] = [icn['GR.EQ.ARMOURED PERSONNEL CARRIER'],ms._scale(0.6,icn['GR.IC.ENGINEER']),icn['GR.EQ.ARMOURED PERSONNEL CARRIER ENGINEER RECON VEHICLE']];
		sId['131400'] = [icn['GR.EQ.UTILITY VEHICLE'],icn['GR.EQ.LIMITED CROSS-COUNTRY'],icn['GR.EQ.UTILITY VEHICLE BACKHOE']];
		sId['131500'] = [icn['GR.EQ.UTILITY VEHICLE'],icn['GR.EQ.LIMITED CROSS-COUNTRY'],ms._scale(0.6,icn['GR.IC.ENGINEER'])];
		...
		sId['140900'] = [icn['GR.EQ.UTILITY VEHICLE'],ms._scale(0.8,icn['GR.IC.FF.CLASS III'])];
		sId['141000'] = [icn['GR.EQ.UTILITY VEHICLE'],ms._scale(0.7,icn['GR.IC.WATER'])];
