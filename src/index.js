...
ms.addSIDCicons(require('./letter-sidc/icons-signalsIntelligence.js'), 'letter');
ms.addSIDCicons(require('./letter-sidc/icons-stabilityoperations.js'), 'letter');
ms.addSIDCicons(require('./letter-sidc/icons-emergencymanagementsymbols.js'), 'letter');
...
ms.addSIDCicons(require('./letter-sidc/icons-tactical-points-2525.js'), 'letter');
ms.addLabelOverrides(require('./letter-labels/tactical-points-2525.js'), 'letter');

ms.addSIDCicons(require('./letter-sidc/icons-tactical-points-app6.js'), 'letter');
ms.addLabelOverrides(require('./letter-labels/tactical-points-app6.js'), 'letter');
...
ms.addSIDCicons(require('./number-sidc/icons-seabedinstallations.js'), 'number');
ms.addSIDCicons(require('./number-sidc/icons-activites.js'), 'number');
ms.addSIDCicons(require('./number-sidc/icons-signalsintelligence.js'), 'number');
