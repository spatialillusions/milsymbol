...
module.exports = function activites(sId,sIdm1,sIdm2,bbox,symbolSet,icn,_STD2525){
	...
	if(symbolSet == "40" ){
		...
		sId['110123'] = [MS._translate(0,10,MS.scale(0.8,icn['AC.IC.CRIMINAL.ACTIVITY.INCIDENT'])),icn['AC.M1.THREAT']];
		...
		sId['110302'] = [MS._translate(0,15,MS.scale(0.7,[icn['ST.IC.EXPLOSION'],icn['ST.IC.IED']])),icn['ST.M1.PREMATURE']];
