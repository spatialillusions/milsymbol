...
module.exports = function ground(sId,bbox,icn,_STD2525){
	...
	sId['S-G-UCECT-'] = [ms._scale(0.7,icn['GR.IC.ENGINEER']),icn['GR.IC.ARMOUR']];
	...
	sId['S-G-UCFHE-'] = [ms._scale(0.8,icn['GR.IC.FIELD ARTILLERY']),icn['GR.IC.ARMOUR']];
	...
	sId['S-G-UCFRS-'] = [ms._scale(0.8,icn['GR.IC.FIELD ARTILLERY']),icn['GR.M1.SINGLE ROCKET LAUNCHER'],(_STD2525 ? [] : icn['GR.IC.ARMOUR'])];
	sId['S-G-UCFRSS'] = [ms._scale(0.8,icn['GR.IC.FIELD ARTILLERY']),icn['GR.M1.SINGLE ROCKET LAUNCHER'],icn['GR.IC.ARMOUR']];
	...
	sId['S-G-UCFTR-'] = [ms._translate(-30,10,ms._scale(0.6,icn['GR.IC.FIELD ARTILLERY'])),icn['GR.IC.RADAR']];
	sId['S-G-UCFTS-'] = [ms._translate(0,30,ms._scale(0.7,icn['GR.IC.FIELD ARTILLERY'])),icn['GR.IC.FF.SOUND']];
	...
	sId['S-G-UCFTCM'] = [ms._scale(0.8,icn['GR.IC.FIELD ARTILLERY']),icn['GR.IC.FF.RECONNAISSANCE'],icn['GR.IC.ARMOUR']];
	...
	sId['S-G-UCFML-'] = [ms._translate(0,-20,icn['GR.IC.MORTAR']),icn['GR.IC.FF.AMPHIBIOUS']];
	...
	sId['S-G-UCRX--'] =	[icn['GR.IC.FF.RECONNAISSANCE'],(_STD2525 ? icn['GR.M2.LONG RANGE SURVEILLANCE'] : [ms._translate(0,-20,icn['GR.M2.MOUNTAIN']),icn['GR.M2.LONG RANGE']])];
	...
	sId['S-G-UCSW--'] =	[ms._translate(0,-20,icn['GR.IC.SECURITY']),icn['GR.IC.FF.AMPHIBIOUS']];
	...
	sId['S-G-UUMS--'] =	[ms._translate(-25,0,icn['GR.IC.MILITARY INTELLIGENCE']),icn['GR.IC.RADIO']];
	...
	sId['S-G-UUMRS-'] = [ms._translate(0,30,ms._scale(0.8,icn['GR.IC.MILITARY INTELLIGENCE'])),icn['GR.IC.FF.SENSOR']];
	sId['S-G-UUMRSS'] = [ms._translate(0,30,ms._scale(0.8,icn['GR.IC.MILITARY INTELLIGENCE'])),icn['GR.IC.FF.SENSOR'],icn['GR.M1.SENSOR CONTROL MODULE']];
	...
	sId['S-G-UULF--'] = [ms._translate(0,-20,icn['GR.IC.SHORE PATROL']),icn['GR.IC.AVIATION FIXED WING']];
	...
	sId['S-G-USS3A-'] = [icn['GR.IC.FF.SUPPLY'],icn['GR.IC.FF.CLASS III'],ms._translate(25,5,ms._scale(0.5,icn['GR.IC.AVIATION ROTARY WING']))];
	sId['S-G-USS3AT'] = [icn['GR.IC.FF.SUPPLY THEATER'],icn['GR.IC.FF.CLASS III'],ms._translate(25,5,ms._scale(0.5,icn['GR.IC.AVIATION ROTARY WING']))];
	sId['S-G-USS3AC'] = [icn['GR.IC.FF.SUPPLY CORPS'],icn['GR.IC.FF.CLASS III'],ms._translate(25,5,ms._scale(0.5,icn['GR.IC.AVIATION ROTARY WING']))];
