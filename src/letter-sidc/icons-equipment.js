...
module.exports = function equipment(sId,bbox,icn,_STD2525){
	...
	sId['S-G-EWMAT-'] = [ms._translate(0,-15,ms._scale(0.7,icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR'])),icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR THEATRE']];
	sId['S-G-EWMATR'] = [ms._translate(0,-15,ms._scale(0.7,icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR'])),icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR THEATRE'],icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR TLAR']];
	sId['S-G-EWMATE'] = [ms._translate(0,-15,ms._scale(0.7,icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR'])),icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR THEATRE'],icn['GR.EQ.AIR DEFENCE MISSILE LAUNCHER SURFACE-TO-AIR TELAR']];
	...
	sId['S-G-EWXL--'] = [icn['GR.EQ.MULTIPLE ROCKET LAUNCHER'],ms._translate(0,10,icn['GR.EQ.SHORT RANGE'])];
	sId['S-G-EWXM--'] = [icn['GR.EQ.MULTIPLE ROCKET LAUNCHER'],ms._translate(0,10,icn['GR.EQ.INTERMEDIATE RANGE'])];
	sId['S-G-EWXH--'] = [icn['GR.EQ.MULTIPLE ROCKET LAUNCHER'],ms._translate(0,10,icn['GR.EQ.LONG RANGE'])];
	...
	sId['S-G-EWZL--'] = [icn['GR.EQ.GRENADE LAUNCHER'],ms._translate(0,20,icn['GR.EQ.SHORT RANGE'])];
	sId['S-G-EWZM--'] = [icn['GR.EQ.GRENADE LAUNCHER'],ms._translate(0,20,icn['GR.EQ.INTERMEDIATE RANGE'])];
	sId['S-G-EWZH--'] = [icn['GR.EQ.GRENADE LAUNCHER'],ms._translate(0,20,icn['GR.EQ.LONG RANGE'])];
	...
	sId['S-G-EWHLS-'] = [ms._translate(0,-15,ms._scale(0.8,[icn['GR.EQ.HOWITZER'],icn['GR.EQ.SHORT RANGE']])),icn['GR.EQ.HOWITZER TRACKED']];
	sId['S-G-EWHM--'] = [icn['GR.EQ.HOWITZER'],icn['GR.EQ.INTERMEDIATE RANGE']];
	sId['S-G-EWHMS-'] = [ms._translate(0,-15,ms._scale(0.8,[icn['GR.EQ.HOWITZER'],icn['GR.EQ.INTERMEDIATE RANGE']])),icn['GR.EQ.HOWITZER TRACKED']];
	sId['S-G-EWHH--'] = [icn['GR.EQ.HOWITZER'],icn['GR.EQ.LONG RANGE']];
	sId['S-G-EWHHS-'] = [ms._translate(0,-15,ms._scale(0.8,[icn['GR.EQ.HOWITZER'],icn['GR.EQ.LONG RANGE']])),icn['GR.EQ.HOWITZER TRACKED']];
	...
	sId['S-G-EWDLS-'] = [ms._translate(0,-15,ms._scale(0.8,[icn['GR.EQ.DIRECT FIRE GUN'],icn['GR.EQ.SHORT RANGE']])),icn['GR.EQ.HOWITZER TRACKED']];
	sId['S-G-EWDM--'] = [icn['GR.EQ.DIRECT FIRE GUN'],icn['GR.EQ.INTERMEDIATE RANGE']];
	sId['S-G-EWDMS-'] = [ms._translate(0,-15,ms._scale(0.8,[icn['GR.EQ.DIRECT FIRE GUN'],icn['GR.EQ.INTERMEDIATE RANGE']])),icn['GR.EQ.HOWITZER TRACKED']];
	sId['S-G-EWDH--'] = [icn['GR.EQ.DIRECT FIRE GUN'],icn['GR.EQ.LONG RANGE']];
	sId['S-G-EWDHS-'] = [ms._translate(0,-15,ms._scale(0.8,[icn['GR.EQ.DIRECT FIRE GUN'],icn['GR.EQ.LONG RANGE']])),icn['GR.EQ.HOWITZER TRACKED']];
	...
	sId['S-G-EVE---'] = [icn['GR.EQ.ARMOURED PROTECTED VEHICLE WITH LIMITED CROSS COUNTRY MOBILITY'],ms._scale(0.7,icn['GR.IC.ENGINEER'])];
	sId['S-G-EVEB--'] = [icn['GR.EQ.BRIDGE']];
	sId['S-G-EVEE--'] = [icn['GR.EQ.EARTHMOVER']];
	//.X.3.2.2.3.2 .1 WRONG SIDC
	//sId['S-G-EVEE--'] = [];
	sId['S-G-EVEC--'] = [icn['GR.EQ.UTILITY VEHICLE'],icn['GR.EQ.LIMITED CROSS-COUNTRY'],ms._scale(0.6,icn['GR.IC.ENGINEER'])];
	...
	sId['S-G-EVEMT-'] = [icn['GR.EQ.MINE CLEARING EQUIPMENT'],ms._translate(0,-10,icn['GR.EQ.LIMITED CROSS-COUNTRY'])];
	...
	sId['S-G-EVEAT-'] = [icn['GR.EQ.MINE CLEARING EQUIPMENT'],ms._translate(0,-10,icn['GR.EQ.LIMITED CROSS-COUNTRY'])];
	...
	sId['S-G-EVES--'] = [icn['GR.EQ.ARMOURED PERSONNEL CARRIER'],ms._scale(0.6,icn['GR.IC.ENGINEER'])];
	sId['S-G-EVER--'] = [icn['GR.EQ.ARMOURED PERSONNEL CARRIER'],ms._scale(0.6,icn['GR.IC.ENGINEER']),icn['GR.EQ.ARMOURED PERSONNEL CARRIER ENGINEER RECON VEHICLE']];
	...
	sId['S-G-EVD---'] = [icn['GR.EQ.UTILITY VEHICLE'],icn['GR.EQ.CROSS-COUNTRY'],ms._scale(0.7,icn['GR.IC.DRILLING'])];
