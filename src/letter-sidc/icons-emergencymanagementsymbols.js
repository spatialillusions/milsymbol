...
module.exports = function emergencymanagementsymbols(sId,bbox,icn,_STD2525){
	...
	sId["E-I-BC----"] = [icn['ST.IC.EXPLOSION'],ms._scale(0.6,icn['ST.IC.BOMB'])];
	...
	sId["E-O-AF----"] = [ms._translate(0,10,ms._scale(0.8,icn['AR.I.FF.CIVILIAN ROTARY WING'])),icn['GR.M1.MEDEVAC']];
	...
	sId["E-O-BD----"] = [ms._scale(0.7,icn['GR.IC.FF.EMERGENCY OPERATION']),icn['AC.M1.EMERGENCY COLLECTION EVACUATION POINT']];
	sId["E-O-BE----"] = [ms._scale(0.7,icn['GR.IC.FF.EMERGENCY OPERATION']),icn['AC.M1.EMERGENCY INCIDENT COMMAND CENTER']];
	sId["E-O-BF----"] = [ms._scale(0.7,icn['GR.IC.FF.EMERGENCY OPERATION']),icn['AC.M1.EMERGENCY OPERATIONS CENTER']];
	sId["E-O-BG----"] = [icn['AC.IC.EMERGENCY PUBLIC INFORMATION CENTER']];
	sId["E-O-BH----"] = [ms._scale(0.7,icn['GR.IC.FF.EMERGENCY OPERATION']),icn['AC.M1.EMERGENCY SHELTER']];
	sId["E-O-BI----"] = [ms._scale(0.7,icn['GR.IC.FF.EMERGENCY OPERATION']),icn['AC.M1.EMERGENCY STAGING AREA']];
	...
	sId["E-O-EA----"] = [ms._scale(0.6,icn['GR.EQ.SENSOR']),icn['GR.M1.BIOLOGICAL']];
	sId["E-O-EB----"] = [ms._scale(0.6,icn['GR.EQ.SENSOR']),icn['GR.M1.CHEMICAL']];
	sId["E-O-EC----"] = [ms._scale(0.6,icn['GR.EQ.SENSOR']),icn['GR.M1.INTRUSION']];
	sId["E-O-ED----"] = [ms._scale(0.6,icn['GR.EQ.SENSOR']),icn['GR.M1.NUCLEAR']];
	sId["E-O-EE----"] = [ms._scale(0.6,icn['GR.EQ.SENSOR']),icn['GR.M1.RADIOLOGICAL']];
