...
var symbolstatus = {};
	...
	symbolstatus.ground = [{code:"-",name:"-"},
		...
		symbolstatus.ground.forEach(function (e,i,a){
			e.children = codes.ground; //TODO fix
		});
...
var affiliation = {};
	affiliation.base = [
		...
		affiliation.base.forEach(function (e,i,a){
			e.children = JSON.parse(JSON.stringify(battledim.base);
		});
	affiliation.stabilityOperations = [
		...
		affiliation.stabilityOperations.forEach(function (e,i,a){
			e.children = battledim.stabilityOperations;
		});

var MS2525C = [{code:"S",name:"WARFIGHTING",children:affiliation.base},
{code:"I",name:"INTELLIGENCE",children:affiliation.base},
