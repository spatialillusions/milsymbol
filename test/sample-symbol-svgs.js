...
export default {
  ...
  SFGXEWMASEMO:
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.2" baseProfile="tiny" width="51.2" height="71.2" viewBox="36 36 128 178"><circle cx="100" cy="100" r="60" stroke-width="4" stroke="black" fill="rgb(128,224,255)" fill-opacity="1" ></circle><path d="m 85,140 30,0 c 0,-20 -30,-20 -30,0 z m 15,-15 0,-65 m -15,80 0,-65 c 0,-20 30,-20 30,0 l 0,65" stroke-width="3" stroke="black" fill="none" ></path><path d="m 85,100 30,0" stroke-width="3" stroke="black" fill="none" ></path><text x="68" y="110" text-anchor="middle" font-size="25" font-family="Arial" font-weight="bold" stroke-width="3" stroke="none" fill="black" >E</text><text x="132" y="110" text-anchor="middle" font-size="25" font-family="Arial" font-weight="bold" stroke-width="3" stroke="none" fill="black" >R</text><g transform="translate(0,160)" stroke-width="4" stroke="black" fill="none" ><path d="M 53,1 l 94,0" ></path><circle cx="58" cy="8" r="8" ></circle><circle cx="142" cy="8" r="8" ></circle></g><path d="M40,185 l120,0 0,25 -120,0 z" stroke-width="4" stroke="black" fill="rgb(255,0,0)" ></path></svg>',
